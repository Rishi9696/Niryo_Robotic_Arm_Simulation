...
class WifiButtonStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WifiButtonStatus(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WifiButtonStatus(null);
...
module.exports = WifiButtonStatus;
