...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetProgram-request>)))
  ...
  "262000074adf8b9fdcd9b55fcec41125")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetProgram-request)))
  "Returns md5sum for a message object of type 'GetProgram-request"
  "262000074adf8b9fdcd9b55fcec41125")
...
(cl:defmethod saved_at-val ((m <GetProgram-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_programs_manager-srv:saved_at-val is deprecated.  Use niryo_robot_programs_manager-srv:saved_at instead.")
  (saved_at m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetProgram-response>)))
  ...
  (cl:format cl:nil "int32 status~%string message~%~%string code~%string description~%string saved_at~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetProgram-response)))
  "Returns full string definition for message of type 'GetProgram-response"
  (cl:format cl:nil "int32 status~%string message~%~%string code~%string description~%string saved_at~%~%~%"))
