...
(defsystem "niryo_robot_rpi-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "StorageStatus" :depends-on ("_package_StorageStatus"))
    (:file "_package_StorageStatus" :depends-on ("_package"))
    (:file "WifiButtonStatus" :depends-on ("_package_WifiButtonStatus"))
    (:file "_package_WifiButtonStatus" :depends-on ("_package"))
  ))